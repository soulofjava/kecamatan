    ...
    <div class="col-md-9">
        <div class="box box-primary">
            <div class="box-header with-border">
                <a href="{{ route('informasi.ppid.index') }}"><button type="button" class="btn btn-info btn-sm"><i class="fa fa-arrow-left"></i> Kembali</button></a>
            </div>
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::textarea('isi', null, ['class' => 'my-editor', 'placeholder' => 'Isi Postingan', 'style' => 'width: 100%; height: 750px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;']) !!}
                    @if ($errors->has('isi'))
