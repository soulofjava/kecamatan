        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ Request::is(['informasi/*']) ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li {{ Request::is(['informasi/ppid*']) ? 'class=active' : '' }}>
                        <a href="{{ route('informasi.ppid.index') }}"><i class="fa fa-circle-o"></i>PPID</a>
                    </li>
                    @endrole
                    @role('super-admin|admin-kecamatan|administrator-website')
            ...
            <li class="treeview {{ Request::is(['admin-komplain*']) ? 'active' : '' }}"><a href="#"><i
                ...
                <ul class="treeview-menu">
                    ...
                    <li {{ Request::is(['admin-komplain*']) ? 'class=active' : '' }}><a
                            href="{{ route('admin-komplain.index') }}"><i class="fa fa-circle-o"></i>Daftar Keluhan</a>
                    </li>
                    @endrole
                    @role('super-admin|admin-komplain|administrator-website')
            ...
            <li class="treeview {{ Request::is(['pesan*']) ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li {{ Request::is(['pesan', 'pesan/masuk' ]) ? 'class=active' : '' }}><a
                            href="{{ route('pesan.index') }}"><i class="fa fa-envelope-o"></i>Pesan Masuk</a></li>
                    <li {{ Request::is(['pesan/keluar']) ? 'class=active' : '' }}><a
                            href="{{ route('pesan.keluar') }}"><i class="fa fa-envelope-open"></i>Pesan Keluar</a></li>
            ...
            <li class="treeview {{ Request::is(['surat*']) ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li {{ Request::is(['surat/arsip*']) ? 'class=active' : '' }}><a
                            href="{{ route('surat.arsip') }}"><i class="fa fa-folder-open"></i>Arsip</a></li>
                    <li {{ Request::is(['surat/pengaturan*']) ? 'class=active' : '' }}><a
                            href="{{ route('surat.pengaturan') }}"><i class="fa fa-gear"></i>Pengaturan</a></li>
                </ul>
            </li>
            @endif

            @if ($user->hasrole(['super-admin', 'administrator-website']))
            <li class="treeview {{ Request::is(['setting*']) ? 'active' : '' }}"><a href="#"><i class="fa fa-cogs"></i>
